/*=====================
 ...
 (function($) {
    ...
    // Set the duration of the countdown in milliseconds (7 days)
    var countdownDuration = 7 * 24 * 60 * 60 * 1000;

    // Set the date we're counting down to
    var countDownDate = new Date(new Date().getTime() + countdownDuration).getTime();
